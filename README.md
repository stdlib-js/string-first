...
```javascript
first = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-first@v0.2.2-umd/browser.js' )
```
...
[@stdlib/string/last]: https://github.com/stdlib-js/string-last/tree/umd
